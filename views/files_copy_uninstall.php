...
<form method="POST">
  ...
  <div class="adm-detail-content-wrap">
    <div class="adm-detail-content">
      <div class="adm-detail-title"><?= Loc::getMessage('FILES_DELETE_SETTINGS') ?> <?= $moduleId; ?></div>
      <div class="adm-detail-content-item-block">
        <table class="adm-detail-content-table edit-table">
          <tbody>
          <tr>
            <td style="width: 50%" class="adm-detail-content-cell-l">
              <?= Loc::getMessage('IS_DELETE_FILES') ?>
              <br />
              <?= $stepValue; ?>
            </td>
            <td style="width: 50%" class="adm-detail-content-cell-r">
              <input
                type="checkbox"
                id="is_delete_files"
                name="<?= AbstractFilesCopyInstaller::IS_DELETE_FILES_INPUT_NAME ?>"
                checked
                class="adm-designed-checkbox"
              />
              <label class="adm-designed-checkbox-label" for="is_delete_files"></label>
            </td>
          </tr>
          </tbody>
        </table>
